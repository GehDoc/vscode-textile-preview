...
- [INTERNAL] Update textile-js to latest version 2.0.116. Fixes #75
...
### Changed
- [DOC] Change sponsor link from Patreon for Librapay
...
### Fixed
- [GIT] Rename some media files, whose were incompatible with Windows


## [1.3.15] - 20220425
### Changed
- [INTERNAL] Prepare update to vscode 1.61.2
...
- Update to vscode 1.61.2


## [1.3.14] - 20220316
### Changed
- [INTERNAL] Prepare update to vscode 1.60.2
- update to vscode 1.60.2
- [INTERNAL] Update dependencies


## [1.3.13] - 20210922
### Changed
- [INTERNAL] Update vsce, to retry to publish as a web extension
