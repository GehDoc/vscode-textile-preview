...
export class VsCodeOutputLogger extends Disposable implements ILogger {
	...
	private readonly outputChannel = lazy(() => this._register(vscode.window.createOutputChannel('Textile')));
	...
	private readTrace(): Trace {
		return Trace.fromString(vscode.workspace.getConfiguration().get<string>('textile.trace', 'off'));
	}
